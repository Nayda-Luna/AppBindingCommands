...
namespace AppBindingCommands.ViewModels
{
    public class UsuarioViewModel : INotifyPropertyChanged
    {
        ...
        {
            if (await Application.Current.MainPage.DisplayAlert("Confirmação", "Confirma a limpezas dos dados?", "Yes", "No"))
            {
                Name = 
                    string.Empty;
                ...
                await Application.Current.MainPage.DisplayAlert("Informação", "Limpezada realizada com sucesso", "OK");
            }
        }
